...
c/********************************************************************/
        ...
        include"ctes3D"
        integer iopt,mmy
c        real*4 fou(*),phys((mgalx+2)*mgalz,*)
...
c           call cft(phys,mgalx+2,2,mx1+1,-1)
c           call pack0(phys,fou,mmy)
...
c/*                                                                  */
c/********************************************************************/
      subroutine deriv(u,du,chi,mmmy)
      use ctes
      implicit none
      include "ctes3D"
      integer mmmy
      complex*8 u(0:mx1,0:mz1,mmmy),du(0:mx1,0:mz1,mmmy)
      character chi
      complex*8    dk
